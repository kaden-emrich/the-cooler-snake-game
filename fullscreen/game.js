...
function newFullscreenGame() {
    gridDiv.style = "width: 100vw; height: 100vh;";

    var w = Math.floor(gridDiv.clientWidth / pixelSizingFactor);
    var h = Math.floor(gridDiv.clientHeight / pixelSizingFactor);

    gridDiv.style = "width: " + (w * pixelSizingFactor) + "px; height: " + (h * pixelSizingFactor)+ "px;";
...
function getUrlItems() {
    ...
    if(parseInt(urlParams.get('scale'))) {
        pixelSizingFactor = parseInt(urlParams.get('scale'));
    }
}
